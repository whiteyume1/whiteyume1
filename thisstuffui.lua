...
game:GetService("UserInputService").InputBegan:Connect(function(Input, GPE)
	...
	if AprilSound then
	    AprilSound.Playing = ScreenGui.Enabled == true and true or false
	end
    end
end)
...
function Core(Title, Parent)
    ...
    elseif not Parent then
        ...
        UITextSizeConstraint.Parent = WindowText
        ...
        local OTS = game:GetService("TweenService"):Create(Arrow, TweenInfo.new(0.3), {Rotation = -90})
        local CTS = game:GetService("TweenService"):Create(Arrow, TweenInfo.new(0.3), {Rotation = 0})
        ...
        WindowButton.MouseButton1Click:Connect(function()
            ...
            if MWindow_Showing then
                OTS:Play()
                Container:TweenSize(ContainerSize, Enum.EasingDirection.Out, Enum.EasingStyle.Linear, 0.025, true)
            else
                CTS:Play()
                Container:TweenSize(UDim2.new(1, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Linear, 0.025, true)
            end
            Container.Visible = MWindow_Showing
        ...
        --[[local Connection;
        local Discon;
        local FStart = WindowFrame.Position
        local DStart;

        Connection = WindowButton.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and MWindow_Showing then
                print(1)
                Discon = false
                FStart = WindowFrame.Position
                DStart = Input.Position
                spawn(function()
                    local Delta = Input.Position - DStart
                    WindowFrame.Position = UDim2.new(FStart.X.Scale, FStart.X.Offset + Delta.X, FStart.Y.Scale, FStart.Y.Offset + Delta.Y)
                end)
	...
	function Window_Data:Folder(Text)
        ...
        Folder.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Folder.TextLabel.TextSize = 15
        Folder.TextLabel.TextXAlignment = Enum.TextXAlignment.Left

        Folder.UITextSizeConstraint.MaxTextSize = 15
        Folder.UITextSizeConstraint.Parent = Folder.TextLabel
        ...
        Folder.OTS = game:GetService("TweenService"):Create(Folder.Arrow, TweenInfo.new(0.25), {Rotation = -90})
        Folder.CTS = game:GetService("TweenService"):Create(Folder.Arrow, TweenInfo.new(0.25), {Rotation = 0})
	...
	function Window_Data:Button(Text, Callback) --> Not Updated
        ...
        Button.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Button.UITextSizeConstraint.MaxTextSize = 15
        Button.UITextSizeConstraint.Parent = Button.TextLabel
    ...
    function Window_Data:Slider(Text, Min, Max, Callback)
        ...
        Slider.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Slider.TextLabel.TextSize = 13
        Slider.TextLabel.TextXAlignment = Enum.TextXAlignment.Left

        Slider.UITextSizeConstraint.MaxTextSize = 13
        Slider.UITextSizeConstraint.Parent = Slider.TextLabel
    ...
    function Window_Data:ColorPicker(Text, Default, Callback)
        ...
        ColorPicker.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ColorPicker.UITextSizeConstraint_2 = Instance.new("UITextSizeConstraint")
        ...
        ColorPicker.TextLabel.TextSize = 13
        ColorPicker.TextLabel.TextWrapped = true
        ColorPicker.TextLabel.TextXAlignment = Enum.TextXAlignment.Left

        ColorPicker.UITextSizeConstraint.MaxTextSize = 13
        ColorPicker.UITextSizeConstraint.Parent = ColorPicker.TextLabel
        ...
        ColorPicker.UITextSizeConstraint_2.MaxTextSize = 18
        ColorPicker.UITextSizeConstraint_2.Parent = ColorPicker.TextLabel_2
    ...
    function Window_Data:Box(Text, Callback) --> Not Updated
        ...
        Box.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Box.UITextSizeConstraint.MaxTextSize = 14
        Box.UITextSizeConstraint.Parent = Box.TextBox
    ...
    function Window_Data:KeyBind(Text, Callback)
        ...
        KeyBind.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        KeyBind.UITextSizeConstraint.MaxTextSize = 16
        KeyBind.UITextSizeConstraint.Parent = KeyBind.TextButton
    ...
    function Window_Data:Label(Text, Color) --> Not Updated (Nothing Changed)
        ...
        Label.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Label.TextLabel.TextSize = 15
        Label.TextLabel.TextWrapped = true

        Label.UITextSizeConstraint.MaxTextSize = 15
        Label.UITextSizeConstraint.Parent = Label.TextLabel
    ...
    function Window_Data:Dropdown(Text, Data, Callback) --> Not Updated
        ...
        Dropdown.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Dropdown.UITextSizeConstraint.MaxTextSize = 15
        Dropdown.UITextSizeConstraint.Parent = Dropdown.TextLabel

        Dropdown.OTS = game:GetService("TweenService"):Create(Dropdown.Arrow, TweenInfo.new(0.25), {Rotation = 180})
        Dropdown.CTS = game:GetService("TweenService"):Create(Dropdown.Arrow, TweenInfo.new(0.25), {Rotation = 90})
        ...
        function Dropdown:AddButton(Text)
            ...
            Dropdown.Button[Text].UITextSizeConstraint = Instance.new("UITextSizeConstraint")
            ...
            Dropdown.Button[Text].TextLabel.TextSize = 15
            ...
            Dropdown.Button[Text].UITextSizeConstraint.MaxTextSize = 15
            Dropdown.Button[Text].UITextSizeConstraint.Parent =  Dropdown.Button[Text].TextLabel
        ...
        function Dropdown.Dropdown_Callback:Set(Data)
            for i,v in next, Dropdown.Button do
                v.Frame:Destroy()
            end
            Dropdown.Button = {}
            for i,v in next, Data do
        ...
        function Dropdown.Dropdown_Callback:Remove()
            ...
            for i,v in next, Dropdown.Button:GetChildren() do
                v.Frame:Destroy()
                v = nil
            end
	...
	function Window_Data:Toggle(Text, Callback)
        ...
        Toggle.UITextSizeConstraint = Instance.new("UITextSizeConstraint")
        ...
        Toggle.UITextSizeConstraint.MaxTextSize = 13
        Toggle.UITextSizeConstraint.Parent = Toggle.TextLabel
...
Window:KeyBind("Toggle", function()
    Toggle:set("Toggle")
end)
